...
<body>
     ...
     <section class="ofert container">
        ...
        <div class="ofert-1">
            <div class="ofert-img">
                <img src="images/toy-boy.png" alt="">
            </div>
            <div class="ofert-txt">
                <h3>Toy boy</h3>
                <a href="#" class="btn-2">informacion</a>
     ...
     <main class="products container" id="lista-1">
        ...
        <div class="product-content">
            ...
            <div class="product">
                <img src="images/lattafa.png" alt="">
                <div class="product-txt">
                    <h3>Lattafa</h3>
                    <p>Calidad Premium</p>
                    <p>$50.000</p>
            ...
            <div class="product">
                <img src="images/212-vip.png" alt="">
                <div class="product-txt">
                    <h3>212 VIP</h3>
                    <p>Calidad Premium</p>
                    <p>$50.000</p>
            ...
            <div class="product">
                <img src="images/victoria-secret.png" alt="">
                <div class="product-txt">
        ...
        <div class="product">
                <img src="images/blackxs.png" alt="">
                <div class="product-txt">
                    <h3>Black XS</h3>
                    <p>Calidad Premium</p>
                    <p>$50.000</p>
            ...
            <div class="product">
                <img src="images/blue-channel.png" alt="">
                <div class="product-txt">
